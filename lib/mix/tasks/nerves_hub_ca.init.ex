defmodule Mix.Tasks.NervesHubCa.Init do
  ...
  def run(args) do
    ...
    gen_ca_cert("root-ca", path)
    gen_int_ca_cert("intermediate-server-ca", path)
    gen_int_ca_cert("intermediate-device-ca", path)
    gen_int_ca_cert("intermediate-user-ca", path)
